...
import com.kingstar.curso.domain.exception.CozinhaNaoEncontradaException;
...
public class CadastroCozinhaService {
	...
	public void excluir(Long cozinhaId) {
		try {
			...
			throw new EntidadeEmUsoException(String.format(MSG_COZINHA_DE_CÓDIGO, cozinhaId));
		}
	}
